...
class ContainerPlatform:
    ...
    def checkDocker():
        ...
        try:
            ...
            informative_text = (
                "Por favor, instale Docker para poder ejecutar la aplicación."
            )
            ...
            return (
                ...
                informative_text,
                solve,
            )  # Debe retornar False para que se muestre el mensaje de error
    ...
    def checkDockerRunning():
        try:
            ...
            informative_text = (
                "Por favor, inicie Docker para poder ejecutar la aplicación."
            )
            # retornar un False y los mensajes de error
    ...
    def checkContainerRunning():
        try:
            ...
            informative_text = (
                "Por favor, inicie un contenedor para poder ejecutar la aplicación."
            )
            # retornar un False y los mensajes de error
            return False, title, text, informative_text
        return True
